#!/usr/bin/env bash
# asp injector (macOS/Linux) РІР‚вЂќ installs asp as default on every agentic system found.
...
# Pre-3.0 block points at the old VAC/ folder РІР‚вЂќ strip it before adding the new one.
